    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Image album</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="../../controleur/saves/save_img_album.php" method="post" enctype="multipart/form-data">
                
                <div class="row mb-3">
                  <label for="image" class="col-sm-3 col-form-label">Photo à ajouter dans l'album</label>
                  <div class="col-sm-10">
