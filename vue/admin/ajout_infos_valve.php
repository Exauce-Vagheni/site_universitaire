    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Info au valve</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ajouter une information au valve</h5>

              <!-- General Form Elements -->
              <form action="../../controleur/saves/save_infos_valve.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="fichier" class="col-sm-3 col-form-label">Pièce jointe</label>
                  <div class="col-sm-10">
