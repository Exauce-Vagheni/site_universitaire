        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="../../controleur/saves/save_commentaire.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  <label for="nom" class="col-sm-3 col-form-label">Nom de la personne</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nom" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="nom" class="col-sm-3 col-form-label">Fonction de la personne</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="fonction" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="commentaire" class="col-sm-3 col-form-label">Contenu du commentaire</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="commentaire" required></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="image" class="col-sm-3 col-form-label">Photo de la personne</label>
                  <div class="col-sm-10">
