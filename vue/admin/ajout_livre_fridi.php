...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">FRIDI</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ajouter une publication FRIDI</h5>

              <!-- General Form Elements -->
              <form action="../../controleur/saves/save_livre_fridi.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="fichier" class="col-sm-2 col-form-label">Fichier de la publication</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="categorie" aria-label="Default select example">
                      <?php include('../../controleur/recuperation/recuperation_categorie.php'); ?> 
                    </select>
                  </div>
                </div>
