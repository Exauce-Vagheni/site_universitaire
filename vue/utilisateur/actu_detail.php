		...
		<body>	
		  <header id="header" id="home">
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Accueil </a>  <span class="lnr lnr-arrow-right"></span><a href="#">Article </a> <span class="lnr lnr-arrow-right"></span> <a href="#"> Detail d'un article</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="post-content-area single-post-area">
				<?php include("../../modele/recup_detail_actu.php"); ?>
			</section>
