		...
		<body>	
		  <header id="header" id="home">
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Accueil </a>  <span class="lnr lnr-arrow-right"></span><a href="valve_communique.php">Valve </a> <span class="lnr lnr-arrow-right"></span> <a href="#"> Horaires</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="post-content-area single-post-area">
				<div class>
					 <h1 style="text-align:center;">Horaires de toutes les facultés </h1>
					 <hr>
                <div class="col-lg-8 posts-list" style="margin:auto;" align="center">
               
							<?php include("../../modele/recup_valve_horaire.php"); ?>
